...
internal class MainAppState : AppState
{
	...
	public MainAppState(IStateManager states, INlpRuntime runtime, INlpParser parser, IIntentSeedExtractor intentExtractor, ISystemIntentEvaluator systemIntentEvaluator)
		: base(states)
	{
		_runtime = runtime ?? throw new ArgumentNullException(nameof(runtime));
		_parser = parser ?? throw new ArgumentNullException(nameof(parser));
		_intentExtractor = intentExtractor ?? throw new ArgumentNullException(nameof(intentExtractor));
		_systemIntentEvaluator = systemIntentEvaluator ?? throw new ArgumentNullException(nameof(systemIntentEvaluator));
