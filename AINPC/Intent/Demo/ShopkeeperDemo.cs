...
internal static class ShopkeeperDemo
{
	...
	private static Actor CreateActor()
	{
		...
		var _intentClassifier = new SimpleIntentClassifier();
		var _itemResolver = new ItemResolver();
		var _actors = new ActorFactory(_characters, _roles, _tools, _items, _intentClassifier, _itemResolver);
